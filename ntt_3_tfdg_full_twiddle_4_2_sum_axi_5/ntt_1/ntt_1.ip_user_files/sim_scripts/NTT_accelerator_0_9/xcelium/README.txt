...
#
# Generated by export_simulation on Sat Apr 18 16:01:05 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './NTT_accelerator_0.sh' script.

./NTT_accelerator_0.sh -reset_run
...
./NTT_accelerator_0.sh -noclean_files

For more information on the script, please type './NTT_accelerator_0.sh -help'.
