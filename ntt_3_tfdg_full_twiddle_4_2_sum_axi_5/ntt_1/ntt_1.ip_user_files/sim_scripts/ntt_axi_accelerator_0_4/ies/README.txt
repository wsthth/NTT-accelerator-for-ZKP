...
#
# Generated by export_simulation on Mon Apr 20 17:07:28 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './ntt_axi_accelerator_0.sh' script.

./ntt_axi_accelerator_0.sh -reset_run
...
./ntt_axi_accelerator_0.sh -noclean_files

For more information on the script, please type './ntt_axi_accelerator_0.sh -help'.
