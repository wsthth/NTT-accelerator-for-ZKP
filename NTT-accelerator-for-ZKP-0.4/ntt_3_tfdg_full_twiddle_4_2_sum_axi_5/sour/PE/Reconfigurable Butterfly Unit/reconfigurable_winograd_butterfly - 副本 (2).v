...
// 更新: 将 twiddle_power 函数替换为 modular_exponentiation 模块实例
// ============================================================================
...
// ============================================================================
// 模幂运算模块实例化 (替换原来的 twiddle_power 函数)
// ============================================================================
                ...
                if (!coeff_ready) begin
                    if (j_counter < MAX_RADIX && k_counter < MAX_RADIX) begin
                        if (!twiddle_power_start && !twiddle_power_done) begin
                            // 启动模幂运算计算 ω^((j*k) % radix_cfg)
                            twiddle_power_base <= twiddle_base;
                            twiddle_power_exp <= (j_counter * k_counter) % radix_cfg;
