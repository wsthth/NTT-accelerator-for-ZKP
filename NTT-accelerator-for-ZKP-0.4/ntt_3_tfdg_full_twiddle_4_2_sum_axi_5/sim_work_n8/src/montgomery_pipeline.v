...
// ============================================================================
// �ļ���: montgomery_pipeline.v
// ����: �ɸ������˷���ˮ��ģ�飨֧��256λ��
//
// ��ˮ�ߴ�����Ϊ3����Ҫ�׶�:
//   1. start �ź��� valid_in ͬ����Ч
//   2. �����Ϊ������Ҫ�׶� stage1_m, stage2_m, stage3_m
//   3. t �źŴ洢�� t_reg ��
// ============================================================================
module montgomery_pipeline #(
    ...
    input  wire                     clk,
    input  wire                     rst_n,
    input  wire                     start,        // valid_in: �˷���ʼ��Ч�ź�
...
// ============================================================================
// Stage 1: ���� m = (t mod R) * N' mod R
// ע��: valid �ź��� start ͬ����start ���ߺ�ʼ����
// ============================================================================
reg                     s1_valid;
reg [TOTAL_BITS-1:0]    s1_t_low;
reg [TOTAL_BITS-1:0]    s1_m;
reg [2*TOTAL_BITS-1:0]  s1_t;         // ����ԭʼ t �ź�
